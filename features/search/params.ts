...
import { DATE_FILTERS, DURATION_FILTERS, LANGUAGE_FILTERS, ORDER_FILTERS } from "@/constants/filters";
import type { SearchFilters } from "@/types/search";

/**
 * Esquema Zod de los query params de la URL. Única fuente de verdad de la
 * forma canónica: /search?q=...&category=...&duration=...&language=...&date=...&order=...
 *
